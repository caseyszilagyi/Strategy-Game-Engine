...
public class InfiniteSlide extends PieceMovement {
   ...
   * single set of coordinates it can take pieces, because it will simply slide until it is able to
   * take a piece. Will be multiple coordinates if it can't, because it will slide until a piece
   * gets in its way. The coordinate object passed into this method is altered, because in theory it
   * should be passed from the front end but not used for anything else besides this method
   *
