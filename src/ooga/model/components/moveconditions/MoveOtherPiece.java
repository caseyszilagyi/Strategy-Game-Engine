...
/**
 * Used to move another piece relative to the piece that was passed. Is executed after the piece
 * passed is moved
 *
...
public class MoveOtherPiece extends Condition {
   ...
   * @param parameters Holds the relative starting x and y coordinates and the ending relative x and
   *                   y coordinates of the piece to move
   * @param piece      The piece that this condition corresponds to
   */
  public MoveOtherPiece(GameBoard gameBoard,
  ...
  public void executeCondition(Coordinate endingCoordinates) {
    ...
    gameBoard.movePiece(relativeStartX + pieceX, relativeStartY + pieceY, relativeEndX + pieceX,
        relativeEndY + pieceY);
  }
}
