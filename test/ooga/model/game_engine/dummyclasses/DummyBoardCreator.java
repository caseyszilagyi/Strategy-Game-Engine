package ooga.model.game_engine.dummyclasses;
 ...
 */
public class DummyBoardCreator extends Creator {
  private static final String dictionary = "abcdefghijklmnopqrstuvwxyz"; //max supported board size is 26x26
  private static final String PATH = "test/ooga/model/game_engine/boardtestfiles";
  ...
  public DummyBoardCreator(String game, FrontEndExternalAPI viewController) {
